...
export default function Chessboard({playMove, pieces}) {
  ...
  function grabPiece(e) {
    ...
    if (element.classList.contains("chess-piece") && chessboard) {
      ...
      const grabY = Math.abs(Math.ceil((e.clientY - chessboard.offsetTop - VERTICAL_AXIS.length * GRID_SIZE) / GRID_SIZE));
  ...
  function dropPiece(e) {
    ...
    if (activePiece && chessboard) {
      ...
      const y = Math.abs(Math.ceil((e.clientY - chessboard.offsetTop - VERTICAL_AXIS.length * GRID_SIZE) / GRID_SIZE));
